...
<div id="headBar"><p class="logoFont">Kex</p></div>
	...
	<div id="userInfo"><?php 
			...
			{
				echo('<p>Welcome, <b>'.$_SESSION['username'].'</b>! Your current balance is: '.$btcbalance.' BTC and ' .$kegbalance.' KEG</p>');
			}
			else
            {
...
<?php 
		...
		<div id="main"><?php 
			if (!isset($_SESSION['username']))
			{
				...
				<br>
				<p><b>Warning:</b> Because Kex does not ask for your email address, your account <b>cannot</b> be recovered if you lose or forget your password!
